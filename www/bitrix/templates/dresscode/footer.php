...
<?$APPLICATION->ShowViewContent('ProductScopeClose')?>
...
<div id="footer">
    <div id="rowFooter">
        <div id="leftFooter">
            <div class="row">
                <div class="column">
                    <span
                        class="heading"><? $APPLICATION->IncludeFile(SITE_DIR . "sect_footer_menu_heading.php", Array(), Array("MODE" => "text", "NAME" => GetMessage("SECT_FOOTER_MENU_HEADING"), "TEMPLATE" => "sect_footer_menu_heading.php")); ?></span>
                    <? $APPLICATION->IncludeComponent(
                        "bitrix:menu",
                        "footerCatalog",
                        array(
                ...
                <div class="column">
                    <span
                        class="heading"><? $APPLICATION->IncludeFile(SITE_DIR . "sect_footer_menu_heading2.php", Array(), Array("MODE" => "text", "NAME" => GetMessage("SECT_FOOTER_MENU_HEADING2"), "TEMPLATE" => "sect_footer_menu_heading2.php")); ?></span>
                    <? $APPLICATION->IncludeComponent(
                        "bitrix:menu",
                        "footerOffers",
                        array(
                ...
                <div class="column">
                    <span
                        class="heading"><? $APPLICATION->IncludeFile(SITE_DIR . "sect_footer_menu_heading3.php", Array(), Array("MODE" => "text", "NAME" => GetMessage("SECT_FOOTER_MENU_HEADING3"), "TEMPLATE" => "sect_footer_menu_heading3.php")); ?></span>
    ...
    <div id="footerBottom">
        <div class="creator">
            <a href="http://seocontext.su/"><img src="<?= SITE_TEMPLATE_PATH ?>/images/dw.png" alt="Разработка и продвижение сайта SeoContext.su"></a>
        </div>
        <div class="social">
            <? $APPLICATION->IncludeComponent(
                "bitrix:main.include",
...
<noindex>
    <div id="footerLine">
        <div class="wrapper">
            <div class="col">
                <div class="item">
                    <a rel="nofollow" href="<?= SITE_DIR ?>callback/" class="callback"><span
                            class="icon"></span> <?= GetMessage("FOOTER_CALLBACK_LABEL") ?></a>
                </div>
                <div class="item">
...
<noscript>
    <div><img src="https://mc.yandex.ru/watch/36535715" style="position:absolute; left:-9999px;" alt=""/></div>
</noscript>
<!-- /Yandex.Metrika counter -->
...
<noscript>
    <div style="position:absolute;left:-10000px;">
        <img src="//top-fwz1.mail.ru/counter?id=2763989;js=na" style="border:0;" height="1" width="1"
             alt="Рейтинг@Mail.ru"/>
    </div>
</noscript>
<!-- //Rating@Mail.ru counter -->
...
<script type='text/javascript'>
    (function(){ var widget_id = 'ikc5JxDelJ';var d=document;var w=window;function l(){
