                                ...
                                <? foreach ($nextElement["ELEMENTS"][1] as $next2Elements): ?>
                                        ...
                                        <? if (!empty($next2Elements["PICTURE"]["src"])): ?>
                                            <a href="<?= $next2Elements["LINK"] ?>" class="menuLink">
                                                <img src="<?= $next2Elements["PICTURE"]["src"] ?>"
                                                     alt="<?= $next2Elements["TEXT"] ?>">
                                            </a>
                                        <? endif; ?>
                                        <a href="<?= $next2Elements["LINK"] ?>" class="menuLink">
                                            <span><?= $next2Elements["TEXT"] ?></span>
                                    ...
                                    <? if (!empty($next2Elements["ELEMENTS"])): ?>
                                        <? foreach ($next2Elements["ELEMENTS"] as $next3Elements): ?>
                                            <li>
                                                <? if (!$next3Elements['SELECTED']): ?>
                                                    <a href="<?= $next3Elements["LINK"] ?>"
                                                       class="menuLink"><?= $next3Elements["TEXT"] ?>
                                                        <small><?= $next3Elements["ELEMENT_CNT"] ?></small>
                                                    </a>
                                                <? else: ?>
                                                    <span href="<?= $next3Elements["LINK"] ?>"
                                                          class="menuLink"><?= $next3Elements["TEXT"] ?>
                                                        <small><?= $next3Elements["ELEMENT_CNT"] ?></small>
                                                            </span>
                                                <? endif ?>
                            ...
                            <ul class="menuItems">
                                <? foreach ($nextElement["ELEMENTS"][2] as $next2Elements): ?>
                                    <li>
                                        ...
                                        <? endif; ?>
                                        <a href="<?= $next2Elements["LINK"] ?>"
                                           class="menuLink"><span><?= $next2Elements["TEXT"] ?></span>
                                            <small><?= $next2Elements["ELEMENT_CNT"] ?></small>
                                        </a>
                                    </li>
                                    <? if (!empty($next2Elements["ELEMENTS"])): ?>
                                    ...
                                    <? foreach ($arResult["PRODUCTS"][$nextElement["ID"]] as $x => $arElement): ?>
                                        <li>
                                            <div class="item product sku"
                                                ...
                                                <div class="tabloid">
                                                    <a href="#" class="removeFromWishlist"
                                                       data-id="<?= $arElement["~ID"] ?>"></a>
                                                    ...
                                                    <? endif; ?>
                                                    <a href="<?= $arElement["DETAIL_PAGE_URL"] ?>" class="picture"><img
                                                    ...
                                                    <a href="#" class="addCart" data-id="<?= $arElement["ID"] ?>"><img
                                                    ...
                                                    <div class="optional">
                                                        <div class="row">
                                                            ...
                                                            <a href="#" class="addCompare label"
                                                               data-id="<?= $arElement["ID"] ?>"><img
                                                                    src="<?= SITE_TEMPLATE_PATH ?>/images/compare.png"
                                                                    alt=""
                                                        ...
                                                        <div class="row">
                                                            <a href="#" class="addWishlist label"
                                                               data-id="<?= $arElement["~ID"] ?>"><img
                                                                    src="<?= SITE_TEMPLATE_PATH ?>/images/wishlist.png"
                                                                    alt=""
                                                                    class="icon"><?= GetMessage("WISHLIST_LABEL") ?></a>
                                                            <? if (/*$arElement["CATALOG_QUANTITY"] > 0*/
                                                            $arElement["CAN_BUY"]
                                                            ): ?>
                                                                <a class="inStock label changeAvailable"><img
                                                            ...
                                                            <? foreach ($arElement["SKU_PROPERTIES"] as $propName => $arNextProp): ?>
                                                                <? if (!empty($arNextProp["VALUES"])): ?>
                                                                    <div class="skuProperty"
                                                                         ...
                                                                         data-level="<?= $level++ ?>">
                                                                        <div
                                                                            class="skuPropertyName"><?= $arNextProp["NAME"] ?></div>
