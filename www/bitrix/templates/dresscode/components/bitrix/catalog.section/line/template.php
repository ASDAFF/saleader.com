...
?>
	<div id="catalogLineList">
		<?foreach($arResult["ITEMS"] as $arElement):?>
			...
			?>
			<div class="itemRow item sku" id="<?=$this->GetEditAreaId($arElement["ID"]);?>" data-product-id="<?=!empty($arElement["~ID"]) ? $arElement["~ID"] : $arElement["ID"]?>" data-iblock-id="<?=$arElement["SKU_INFO"]["IBLOCK_ID"]?>" data-prop-id="<?=$arElement["SKU_INFO"]["SKU_PROPERTY_ID"]?>">
				<div class="column">
				...
				<div class="column">
					<div class="resizeColumn">
						<span class="priceLabel"><?=GetMessage("CATALOG_PRICE_LABEL")?></span><a class="price"><?=$arElement["MIN_PRICE"]["PRINT_DISCOUNT_VALUE"]?>
