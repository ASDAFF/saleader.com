...
// 	while($rsTempl = $rsTemplates->Fetch()){
// 		if(strstr($rsTempl["TEMPLATE"], "Electro") || strstr($rsTempl["TEMPLATE"], "electro")){
// 			$obSite = new CSite();
// 			$tRes = $obSite->Update($arSite["LID"], array(
// 					"ACTIVE" => "Y",
// 					"TEMPLATE" => array(
// 						array(
// 							"CONDITION" => "",
