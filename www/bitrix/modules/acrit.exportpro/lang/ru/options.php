...
<fieldset title='Обратная связь'>
	 ...
	 <a href='https://www.acrit-studio.ru/services/' target='_blank' title='Услуги по созданию и продвижению сайтов'>Разработка, продвижение,</a> а также <a href='https://www.acrit-studio.ru/technical-support/' target='_blank'>техническая поддержка:</a> <br/>
	 <a href='https://www.acrit-studio.ru/market/' title='Используя наши тиражные решения вы сможете расширить охват вашей целевой аудитории и получить дополнительных клиентов'>Узнайте как увеличить прибыль с сайта</a>&nbsp; +7 495 008 8452; <a href='mailto:design@acrit-studio.ru' title='Электронная почта Веб студии АКРИТ'>design@acrit-studio.ru</a> <br/>
		 Заказ <a href='https://www.acrit-studio.ru/technical-support/' target='_blank' title='Если у вас возникли какие то сложности или задачи по сайту обращайтесь по данной ссылке'>доработок и&nbsp;техподдержка сайтов через службу Технической поддержки</a>
</fieldset>
";
