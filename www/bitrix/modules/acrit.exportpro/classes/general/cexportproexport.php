            ...
            if( !$allPages && $allPages != -1 && !$cronrun ){
                ...
                if( $this->profile["SETUP"]["FILE_TYPE"] != "csv" ){
                    ...
                    $defaultFields = array(
                        ...
                        "#CATEGORY#" => ( ( $this->profile["USE_MARKET_CATEGORY"] == "Y" ) && ( $this->profile["CHANGE_MARKET_CATEGORY"] == "Y" ) ) ? $this->GetYandexCategoryXML( CAcritExportproTools::GetSections( $this->profile ) ) : $this->GetCategoryXML( CAcritExportproTools::GetSections( $this->profile ) ),
    ...
    private function GetYandexCategoryXML( $sections ){
        ...
        foreach( $arMarketProcessCategory as $marketProcessCategoryIndex => $marketProcessCategoryItem ){
            ...
            foreach( $arMarketProfileData as $marketProfileDataIndex => $marketProfileDataItem ){
                if( stripos( $marketProfileDataItem, $marketProcessCategoryItem ) !== false ){
