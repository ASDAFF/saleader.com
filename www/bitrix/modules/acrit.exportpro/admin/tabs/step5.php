                                    ...
                                    <?if( is_array( $field["CONVERT_DATA"] ) ){
                                        foreach( $field["CONVERT_DATA"] as $convertDataId => $fields ){?>
                                            <tr class="convert-fieldset-item" data-id="<?=$convertDataId?>">
                                                <td align="right">
                                                    <input type="text" name="PROFILE[XMLDATA][<?=$id?>][CONVERT_DATA][<?=$convertDataId?>][0]" value="<?=htmlspecialchars( $fields[0], ENT_QUOTES );?>" />
                                                </td>
                                                <td align="left" style="position: relative" class="adm-detail-content-cell-r">
                                                    <input type="text" name="PROFILE[XMLDATA][<?=$id?>][CONVERT_DATA][<?=$convertDataId?>][1]" value="<?=htmlspecialchars( $fields[1], ENT_QUOTES );?>" />
                                                    <span class="fieldset-item-delete">&times</span>
                                                </td>
                                            </tr>
                                            <tr>
