            ...
            <tbody>
                ...
                <?if( file_exists( $_SERVER["DOCUMENT_ROOT"]."/bitrix/tools/acrit.exportpro/export_{$arProfile["ID"]}_run.unlock" ) ){?>
                    <tr id="unlock-container">
                        ...
                        <a class="adm-btn adm-btn-save" onclick="ClearExportData( <?=$arProfile["ID"]?> ); window.location='acrit_exportpro_edit.php?ID=<?=$arProfile["ID"]?>'"><?=GetMessage( "ACRIT_EXPORTPRO_EXPORT_UNLOCK_PAGE_CLEAR_SESSION" )?></a>
