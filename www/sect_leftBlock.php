<div id="left">
    <? $is_catalog = $APPLICATION->GetCurDir() == SITE_DIR . 'catalog/'; ?>
    <? if (!$is_catalog): ?>
        <a href="<?=SITE_DIR . 'catalog/' ?>"
           class="heading orange<? $APPLICATION->ShowViewContent("menuRollClass"); ?>"
           id="catalogMenuHeading"><?= GetMessage("DRESS_CATALOG") ?>
            <ins></ins>
        </a>
        <? else: ?>
        <span class="heading orange<? $APPLICATION->ShowViewContent("menuRollClass"); ?>"
              id="catalogMenuHeading"><?= GetMessage("DRESS_CATALOG") ?>
            <ins></ins>
		</span>
    <? endif ?>
